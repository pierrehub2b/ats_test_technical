...
public class StartAndStop extends ActionTestScript{

	/**
	* Test Name : <b>mobile.ios.channel.StartAndStop</b>
	* Generated at : <b>8 sept. 2020 à 17:17:57</b>
	*/

	public StartAndStop(){super();}
	public StartAndStop(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(1,new ActionChannelStart(this, "Chrome", clv("mobile://192.168.1.41:8080/com.android.chrome"), new String[]{}));
		exec(2,new ActionChannelClose(this, "Chrome", false));
	}
}