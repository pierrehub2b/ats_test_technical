...
public class GoToURL extends ActionTestScript{
	...
	*/
	...
	public GoToURL(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "navigationGoTo", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionAssertCount(this, true, 0, 0, el(0, "IMG", prp(false, "alt", clv("ActionTestScript"))), Operators.EQUAL, 1));
		exec(2,new ActionGotoUrl(this, true, clv(prm(1))));
		exec(3,new ActionAssertCount(this, true, 0, 0, el(0, "IMG", prp(false, "alt", clv("Agilitest"))), Operators.EQUAL, 1));
		exec(4,new ActionChannelClose(this, "navigationGoTo", false));
	}
}