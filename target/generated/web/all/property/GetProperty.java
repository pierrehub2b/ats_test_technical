...
public class GetProperty extends ActionTestScript{

	/**
	* Test Name : <b>web.all.property.GetProperty</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public GetProperty(){super();}
	public GetProperty(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		Variable property = var("property");

		//   ---< Actions >---   //

		exec(0,new ActionChannelStart(this, "preopertyGet", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionGotoUrl(this, true, clv(prm(1))));
		exec(2,new ActionProperty(this, true, 0, 0, el(0, "H1", prp(false, "text", clv("Calculatrice :"))), "text", property));
		exec(3,new ActionAssertValue(this, true, true, clv(property), clv("^(?!\\s*$).+")));
		exec(4,new ActionChannelClose(this, "preopertyGet", false));
	}
}