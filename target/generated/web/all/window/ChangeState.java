...
public class ChangeState extends ActionTestScript{

	/**
	* Test Name : <b>web.all.window.ChangeState</b>
	* Generated at : <b>8 sept. 2020 à 17:56:43</b>
	*/

	public ChangeState(){super();}
	public ChangeState(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "windowChangeState", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionWindowState(this, "reduce"));
		exec(2,new ActionWindowState(this, "restore"));
		exec(4,new ActionChannelClose(this, "windowChangeState", false));
	}
}