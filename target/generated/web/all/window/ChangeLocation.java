...
public class ChangeLocation extends ActionTestScript{

	/**
	* Test Name : <b>web.all.window.ChangeLocation</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public ChangeLocation(){super();}
	public ChangeLocation(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "windowChangeLocation", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionWindowResize(this, 200, 200, null, null));
		exec(2,new ActionChannelClose(this, "windowChangeLocation", false));
	}
}