...
public class ChangeSize extends ActionTestScript{

	/**
	* Test Name : <b>web.all.window.ChangeSize</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public ChangeSize(){super();}
	public ChangeSize(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "windowChangeSize", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionWindowResize(this, null, null, 20, 20));
		exec(2,new ActionChannelClose(this, "windowChangeSize", false));
	}
}