...
public class Switch extends ActionTestScript{
	...
	/**
	* Test Name : <b>web.all.window.Switch</b>
	...
	*/
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "windowSwitch", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionScripting(this, true, 0, 0, null, clv("window.open()"), null));
		exec(2,new ActionWindowSwitch(this, 0, 0));
		exec(3,new ActionWindowSwitch(this, 0, 1));
		exec(4,new ActionChannelClose(this, "windowSwitch", false));
	}
}