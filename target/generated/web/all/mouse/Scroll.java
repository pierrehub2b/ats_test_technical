...
public class Scroll extends ActionTestScript{

	/**
	* Test Name : <b>web.all.mouse.Scroll</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public Scroll(){super();}
	public Scroll(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "mouseScroll", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionGotoUrl(this, true, clv(prm(1))));
		exec(2,new ActionMouseScroll(this, true, 0, 0, el(0, "BODY"), ms(1000)));
		exec(3,new ActionAssertCount(this, true, 0, 0, el(0, "H1", prp(false, "text", clv("Select size 4 :"))), Operators.EQUAL, 1));
		exec(4,new ActionChannelClose(this, "mouseScroll", false));
	}
}