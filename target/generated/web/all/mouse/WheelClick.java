...
public class WheelClick extends ActionTestScript{

	/**
	* Test Name : <b>web.all.mouse.WheelClick</b>
	* Generated at : <b>8 sept. 2020 à 17:56:43</b>
	*/

	public WheelClick(){super();}
	public WheelClick(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "mouseWheelClick", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionGotoUrl(this, true, clv("https://www.agilitest.com/")));
		exec(2,new ActionMouseKey(this, false, 0, 0, el(0, "A", prp(false, "id", clv("hs-eu-confirmation-button"))), ms(Mouse.CLICK)));
		exec(3,new ActionMouseKey(this, true, 0, 0, el(0, "IMG", prp(false, "alt", clv("Agilitest"))), ms(Mouse.WHEEL_CLICK)));
		exec(4,new ActionChannelClose(this, "mouseWheelClick", false));
	}
}