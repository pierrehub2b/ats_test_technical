...
public class DoubleClick extends ActionTestScript{

	/**
	* Test Name : <b>web.all.mouse.DoubleClick</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public DoubleClick(){super();}
	public DoubleClick(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "mouseDoubleClick", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionGotoUrl(this, true, clv(prm(1))));
		exec(2,new ActionMouseKey(this, true, 0, 0, el(0, "BUTTON", prp(false, "text", clv("Double Click Button"))), ms(Mouse.DOUBLE_CLICK)));
		exec(3,new ActionAssertCount(this, true, 0, 0, el(0, "SPAN", prp(false, "text", clv("OK")), prp(false, "id", clv("doubleclickbutton"))), Operators.EQUAL, 1));
		exec(4,new ActionChannelClose(this, "mouseDoubleClick", false));
	}
}