...
public class Over extends ActionTestScript{

	/**
	* Test Name : <b>web.all.mouse.Over</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public Over(){super();}
	public Over(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "mouseOver", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionGotoUrl(this, true, clv(prm(1))));
		exec(2,new ActionMouse(this, true, 0, 0, el(0, "SPAN", prp(false, "text", clv("Mouse Enter Area")), prp(false, "class", clv("mousearea"))), ms(Mouse.OVER)));
		exec(3,new ActionAssertCount(this, true, 0, 0, el(0, "SPAN", prp(false, "text", clv("OK")), prp(false, "id", clv("onmouseenter"))), Operators.EQUAL, 1));
		exec(4,new ActionChannelClose(this, "mouseOver", false));
	}
}