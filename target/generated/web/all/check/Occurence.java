...
public class Occurence extends ActionTestScript{

	/**
	* Test Name : <b>web.all.check.Occurence</b>
	* Generated at : <b>8 sept. 2020 à 17:28:54</b>
	*/

	public Occurence(){super();}
	public Occurence(com.ats.executor.ActionTestScript sc){super(sc);}
	...
	public void testMain(){
		...
		exec(0,new ActionChannelStart(this, "occurenceChannel", clv(prm(0, "chrome")), new String[]{}));
		exec(1,new ActionGotoUrl(this, true, clv(prm(1))));
		exec(2,new ActionAssertCount(this, true, 0, 0, el(0, "IMG", prp(false, "alt", clv("Agilitest"))), Operators.EQUAL, 1));
		exec(3,new ActionChannelClose(this, "occurenceChannel", false));
	}
}